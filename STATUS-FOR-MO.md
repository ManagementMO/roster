...
> **Single source of truth for where the project stands, what's left, and what awaits YOUR decision.** Last full update: **2026-08-20**, after the packed-tarball fresh-install verification on current `origin/main`. Read top to bottom; **§2 and §3 are yours**, **§4 and §7 are the deep "what's left" map**.
>
...
| Gate | Status |
|---|---|
| Unit/integration tests | **405 passing across 16 files** on the current hardening branch (369/14 on the `9741ff6` base it audited; +36 tests covering permissions, platform-neutral shutdown, receipt truthfulness, persistent-slot lock recovery, and publish/install behavior) |
