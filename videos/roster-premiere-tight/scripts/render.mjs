...
try {
  ...
  run("ffmpeg", ["-hide_banner","-y","-i","renders/roster-tight-picture-120fps.mp4","-i","assets/audio/full-send-final.wav",
    "-map","0:v:0","-map","1:a:0","-c:v","copy","-c:a","aac","-b:a","256k","-t","15","-movflags","+faststart","renders/roster-tight-120fps.mp4"]);
  console.log("Rendered 120fps picture and muxed the mastered original score: renders/roster-tight-120fps.mp4");
} finally {
