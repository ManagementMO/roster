...
const share = "renders/roster-feed-60fps.mp4";
const preview = "renders/roster-feed-preview.mp4";
const poster = "renders/roster-feed-poster.png";
const contact = "renders/roster-feed-contact-sheet.png";
...
for(const [file,filter,crf] of [[share,"fps=60","18"],[preview,"scale=864:1080:flags=lanczos,fps=60","22"]]){
