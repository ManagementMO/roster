...
try {
  ...
  run("ffmpeg", ["-hide_banner","-y","-i","renders/roster-feed-picture-120fps.mp4","-i",soundtrack,
    "-map","0:v:0","-map","1:a:0","-c:v","copy","-c:a","aac","-b:a","256k","-t","15","-movflags","+faststart","renders/roster-feed-120fps.mp4"]);
  console.log("Rendered 120fps picture and muxed the mastered soundtrack: renders/roster-feed-120fps.mp4");
} finally {
