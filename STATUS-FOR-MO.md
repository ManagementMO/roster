...
| Gate | Status |
|---|---|
| Unit/integration tests | **398 passing across 16 files** on current `origin/main` (369/14 on the `9741ff6` base it audited; +29 tests covering permissions, platform-neutral shutdown, receipt truthfulness, lock recovery, and publish/install behavior) |
